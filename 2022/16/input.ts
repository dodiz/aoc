export const input = `Valve SW has flow rate=0; tunnels lead to valves LX, LD
...
export const inputMock = `Valve AA has flow rate=0; tunnels lead to valves DD, II, BB
